 ...
 *
 * When ShopEngine installs another plugin during onboarding, mark() does two things:
...
class Auto_Install_Tracker {
	...
	/**
	 * Core wpmet plugins that ShopEngine knows about by default.
	 ...
	 *
	 * @param string $plugin_file  e.g. 'metform/metform.php'
	 * @param string $installed_by Slug of the plugin that triggered the install.
	 */
	public static function mark( string $plugin_file, string $installed_by = 'shopengine' ): void {
