		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-product-category-lists .cat-icon svg' => 'width: {{SIZE}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-product-category-lists .shopengine-category-items .shopengine-category-icon svg' => 'fill:{{VALUE}};transition: all 0.3s ease-in-out;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-product-category-lists .shopengine-category-items:hover .shopengine-category-icon svg' => 'fill:{{VALUE}};',
				],
			]
		);
