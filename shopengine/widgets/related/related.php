...
class ShopEngine_Related extends \ShopEngine\Base\Widget
{
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shopengine_related_product_show_products_heading',
			[
		...
		$this->add_control(
			'shopengine_related_product_show_products_heading_title',
			[
		...
		$this->add_control(
			'shopengine_related_product_hide_if_products_not_found',
			[
				'label'        => esc_html__('Hide if no products found', 'shopengine'),
				'description' => esc_html__('If no related products found, the widget will be hidden.', 'shopengine'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'shopengine'),
				'label_off'    => esc_html__('No', 'shopengine'),
				'return_value' => 'yes',
		 ...
		 */
		$this->start_controls_section(
			'shopengine_related_product_heading_text_style',
			[
				'label' => esc_html__('Heading Text', 'shopengine'),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		...
		$this->add_control(
			'shopengine_related_product_heading_text_color',
			[
				'label'     => esc_html__('Color', 'shopengine'),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#101010',
				'alpha'     => false,
				'selectors' => [
					'{{WRAPPER}} .shopengine-related .shopengine-related-products-heading-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'           => 'shopengine_related_product_heading_text_typography',
				'label'          => esc_html__('Typography', 'shopengine'),
				'selector'       => '{{WRAPPER}} .shopengine-related .shopengine-related-products-heading-title',
				'exclude'        => ['font_family', 'letter_spacing', 'text_decoration', 'font_style'],
				'fields_options' => [
					'font_weight'    => [
						'default' => '600',
		...
		$this->add_responsive_control(
			'shopengine_related_product_heading_text_padding',
			[
				'label'      => esc_html__('Padding (px)', 'shopengine'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px'],
				...
				'selectors'  => [
					'{{WRAPPER}} .shopengine-related .shopengine-related-products-heading-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'.rtl {{WRAPPER}} .shopengine-related .shopengine-related-products-heading-title' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
				],
                'separator'	=> 'before',
			]
		);
	...
	protected function render_view($settings = []) {
		...
		$shopengine_related_product_columns = isset($settings['shopengine_related_product_columns']) ? $settings['shopengine_related_product_columns'] : 4;
