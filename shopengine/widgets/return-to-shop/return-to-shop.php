		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.rtl {{WRAPPER}}.elementor-align-left .shopengine-return-to-shop .return-to-shop' => 'text-align:right;',  
					'.rtl {{WRAPPER}}.elementor-align-right .shopengine-return-to-shop .return-to-shop' => 'text-align:left;',
				],
				...
				'fields_options' => [
					...
					'width' => [
						...
						'selectors' => [
							...
							'.rtl {{WRAPPER}} .shopengine-return-to-shop .button' => 'border-width: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}} !important;',
						],
						'responsive' => false,
					],
				...
				'fields_options' => [
					...
					'width' => [
						...
						'selectors' => [
							...
							'.rtl {{WRAPPER}} .shopengine-return-to-shop .button:hover' => 'border-width: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}} !important;',
						],
						'responsive' => false,
					],
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					...
					'.rtl {{WRAPPER}} .shopengine-return-to-shop .button' => 'border-radius: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}} !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					...
					'.rtl {{WRAPPER}} .shopengine-return-to-shop .button' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
				],
			]
		);
